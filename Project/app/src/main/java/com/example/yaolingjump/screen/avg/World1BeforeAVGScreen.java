...
public class World1BeforeAVGScreen extends AVGScreen {
    private LPaper btnJump;
    private LPaper roleName;
    private int marginH=5;
    private int marginV=5;
    public World1BeforeAVGScreen(){
        super(MyAssets.SCRIPT_WORLD1_BEFORE, AVGDialog.getRMXPDialog(MyAssets.AVG_MESSAGE,
                460, 150));
